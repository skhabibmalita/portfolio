...
<head>
  ...
  <title>Job Profile - Habib</title>
  <!-- Google Fonts -->
  <link
    href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&family=Great+Vibes&display=swap"
    rel="stylesheet"
  />
  <style>
    /* Global Styles */
    ...
    /* Highlight About Me and My Skills headings */
    #about h2, #skills h2 {
      font-size: 2.5em;
      color: #ff758c;
...
<body>
  ...
  <script>
    ...
    // BMI Calculator function (converts ft to meters, calculates BMI and updates custom meter)
    ...
    // Normal Calculator function (performs the selected arithmetic operation)
    function calculate() {
